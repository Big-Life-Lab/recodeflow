...
pkg.env$columns.Variables <- "variable"
pkg.env$columns.VariableLabel <- "labelLong"
pkg.env$columns.VariableLabelShort <- "label"
pkg.env$columns.DatabaseStart <- "databaseStart"
pkg.env$columns.VariableStart <- "variableStart"
pkg.env$columns.CatValue <- "recTo"
pkg.env$columns.From <- "recFrom"
