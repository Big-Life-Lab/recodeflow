...
`recodeflow` recodes missing data categories values into 
3 NA values that are commonly used for most studies. NA(a) = 'not applicable' 
...
or coded in surveys, recoded to NA(c)
