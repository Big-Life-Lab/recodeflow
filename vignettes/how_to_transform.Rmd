...
We have examples to demonstrate how to recode variables with the _recodeflow_ function [`rec_with_table()`](../reference/rec_wtih_table.html)
...
## Example 5. Recode all variables in variables {#example5}
