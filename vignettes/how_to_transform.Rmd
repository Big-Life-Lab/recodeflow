...
Transform the `agegrp` variable into a common variable ariables that cannot be combined across
cycles. The categories in `age` variable in the CCHS changed in 2005 and
therefore it is not possible to have the same `agegrp` categories across all CCHS
cycles.
