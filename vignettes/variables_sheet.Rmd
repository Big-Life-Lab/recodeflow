...
This vignette describes how the `variables` worksheet is organized and how to find variables that you can transform. The [How to guides](../reference/how_to_guides.html) provides examples of how to use the this. 
