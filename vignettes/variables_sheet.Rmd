...
This vignette describes how the `var_sheet` is organized and how to find variables that you can transform. See also the vignette `variable details`. The [Get Started](https://big-life-lab.github.io/recodeflow/articles/get_started.html) vignette provides examples of how to use the two worksheets. 
