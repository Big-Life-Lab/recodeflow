...
-   To provide a reproducible, transparent, and streamlined process to recode and transform data, especially in the context of preparing it for analysis in healthcare research.
...
data_1_2 <- tibble(ADL_005 = c(7, 7, 8, 8, 9, 9))
data_1_2
```
...
data_1_5 <- tibble(DHHGAGE = c(11, 12, 13, 14, 15, 16))
data_1_5
```
...
```{r feature-1-5-after}
data_1_5 |> 
  mutate(DHHGAGE = case_when(8 <= DHHGAGE & DHHGAGE <= 11 ~ 3,
...
data_1_8 <- tibble(PAYDVDYS = c(0, 2, 3, 4, 6, 7))
data_1_8
```
